...
runImmuneLENS <- function(vdj.region.df, vdj.gene = 'TCRA',
                                            hg19_or_38 = 'hg38',
                                            GC_correct = TRUE,
  ...
  # Remove any flagged exons (100bp)
  if(removed_flag){
  ...
  out.summarise <- summariseWGS(out.df, vdj.gene)
  return(out.summarise)
}
